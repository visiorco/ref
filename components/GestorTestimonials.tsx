...
import styles from './GestorTestimonials.module.css';

const testimonials = [
    { id: 1, vimeoId: '1149732076' },
    { id: 2, vimeoId: '1047105990' },
    { id: 3, vimeoId: '1047112195' },
    { id: 4, vimeoId: '1151905380' },
];

// Duplicate items for infinite scroll effect
const extendedTestimonials = [...testimonials, ...testimonials, ...testimonials];

export default function GestorTestimonials() {
