...
export default function Home() {
    ...
    return (
        <div className={`${styles.pageWrapper} ${isDarkMode ? styles.darkMode : ''}`}>
                ...
                <div className={styles.heroContainer}>
                    ...
                    <div className={styles.contentSection}>
                        <h1 className={styles.headline}>
                            Como atrair <strong>clientes que pagam mais</strong>, dão valor ao seu trabalho e te recomendam <strong>naturalmente</strong>
                        </h1>

                        <p className={styles.description}>
                            Existe um tipo de clientes que é mais consciente, segue suas orientações e impulsiona o seu posicionamento. Você só precisa saber como se tornar a escolha óbvia para ele.
                        </p>
                ...
                <div className={styles.storyGrid}>
                    ...
                    <div className={styles.storyRight}>
                        <div className={styles.storyTextLarge}>
                            <p>
                                Se <strong>você está cansado de ver pessoas que começarem depois do que você,</strong> menos capacitadas que não entregam tudo o que você entrega, mas… <strong>possuem um resultado mais alto do que o seu, alcançam clientes mais relevantes,</strong> faturam mais e tem mais visibilidade no que fazem do que você.
                            </p>
                        </div>
            ...
            <section className={styles.pillarsSection}>
                <div className={styles.successGrid}>
                    ...
                    <div className={styles.successRight}>
                        ...
                        <p className={styles.successDesc}>
                            <strong>Se você tem um negócio ou é um profissional liberal que vende um produto ou serviço</strong>, esse conteúdo será cirurgicamente pra você, porque afinal o nosso objetivo é trabalhar com profissionais que podem <strong>cobrar mais por seu trabalho e serem mais valorizados.</strong>
                        </p>
                    </div>
                </div>
            </section>

            <MethodologySection scrollToPricing={scrollToPricing} mode="cliente" />
                        ...
                        <div className={styles.whiteNestedCard}>
                            <div className={styles.nestedList}>
                                {[
                                    ...
                                    "Irá evitar que continue chegando clientes que não te valorizam e insistem em pedir desconto e ainda te comparam com pessoas que não são tão boas quanto você;",
            ...
            <InvestmentSection openModal={openModal} mode="cliente" />
